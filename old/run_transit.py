...
def save_models(data_dir, tic, deltaloglike_values, planet_results, planet_models, planet_solns, no_pl_models, no_pl_solns, planet_outmasks, vet=False, vet_dir='.'):
...
def get_results(tic, time, norm_flux, norm_flux_err, cads, data_dir, fig_dir, vet=False, vet_dir='.'):
    ...
    save_models(data_dir, tic, deltaloglike_values, planet_results, planet_models, planet_solns, no_pl_models, no_pl_solns, planet_outmasks, vet, vet_dir)
    ...
    for tic in multi_tic:
        ...
        if len(time) == 0:
            ...
            if do_even_odd == False:
                ...
                get_results(tic, time, norm_flux, norm_flux_err, cads, data_dir, fig_dir, vet=True, vet_dir=vet_dir)
